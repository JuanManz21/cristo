...
class Pedido {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . "
                  SET id_usuario=:id_usuario, fecha_entrega=:fecha_entrega,
                      direccion_entrega=:direccion_entrega, mensaje_personalizado=:mensaje_personalizado,
        ...
        $this->mensaje_personalizado = htmlspecialchars(strip_tags($this->mensaje_personalizado));
        ...
        $stmt->bindParam(":mensaje_personalizado", $this->mensaje_personalizado);
