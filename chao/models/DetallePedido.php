    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . "
                  SET id_pedido=:id_pedido, id_producto=:id_producto,
                      ...
                      subtotal=:subtotal, mensaje_especial=:mensaje_especial";
        ...
        $this->mensaje_especial = htmlspecialchars(strip_tags($this->mensaje_especial));
        ...
        $stmt->bindParam(":mensaje_especial", $this->mensaje_especial);
