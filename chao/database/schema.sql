...
CREATE TABLE pedidos (
    ...
    estado ENUM('aprobado', 'pendiente', 'confirmado', 'preparando', 'entregado', 'cancelado') DEFAULT 'aprobado',
    total DECIMAL(10,2) NOT NULL,
    metodo_pago ENUM('efectivo', 'tarjeta', 'transferencia', 'billetera') DEFAULT 'billetera',
...
('Muffins de Arándanos y Limón', 'Muffins esponjosos con un toque de limón y arándanos frescos, ideales para un momento de calma', 20.00, 2, 'Un bocado de esperanza para recordarte que todo estará bien', 'public/blueberry-muffins-with-lemon-hope-comfort.jpg'),
...
-- Insert admin user
INSERT INTO usuarios (nombre, apellido, email, tipo_usuario, password_hash) VALUES
('Admin', 'User', 'admin@gmail.com', 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'); -- password is password
